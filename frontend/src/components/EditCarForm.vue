  ...
  <div v-if="isVisible">
    <form @submit.prevent="saveCar">
      ...
      <input
        ...
        v-model="editedCar.transmission_type"
        class="border rounded-md px-2 py-1"
      />
      ...
      <input
        type="text"
        id="number_of_seats"
        v-model="editedCar.number_of_seats"
        class="border rounded-md px-2 py-1"
      />
      ...
      <div v-for="(feature, index) in editedCar.features" :key="index" class="mb-2">
        ...
        <input
          type="text"
          :id="'feature-' + index"
          v-model="editedCar.features[index]"
          class="border rounded-md px-2 py-1"
        />
        <button
          type="button"
      ...
      <button type="button" @click="addFeature" class="bg-green-500 text-white px-2 py-1 rounded">
        Add Feature
      </button>
      ...
      <button
        type="button"
        @click="$emit('cancel')"
        class="bg-gray-500 text-white px-4 py-2 rounded-md mt-4 ml-2"
      >
        Cancel
      </button>
    </form>
